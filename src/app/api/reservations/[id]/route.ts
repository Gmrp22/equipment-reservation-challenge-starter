...
import { updateReservation } from "@/server/reservations/reservation-mutations";
...
export async function PUT(
  ...
  try {
    ...
    return NextResponse.json(
      { error: "The reservation could not be updated. Please try again.", code: "INTERNAL_ERROR" },
      { status: 500 },
    );
  }
}
